...
* typically a string in the format "KEY=VALUE".
...
* and frees each node's key, value, and the node itself.
*/
...
/**
* @brief Switches the position of the current node with the next node
* in the linked list until the node is in the correct order.
...
* This function is used to sort the linked list of environment variables
 ...
 * @param _env a t_env pointer to the head of the linked list
 * that will store the environment variables.
 * @param var a string representing the variable to be checked,
 ...
 * If the variable exists, it updates its value and visibility. 
 * If the variable does not exist, it adds it to the linked list.
 * @param _env a t_env pointer to the head of the linked list
 *  that will store the environment variables.
 * @param var a string representing the variable to be updated,
 *  typically in the format "KEY=VALUE".
 * If the variable has an equal sign, it updates the value.
 * If it does not have an equal sign, it hides the variable.
 ...
 * @param _env a t_env pointer to the head of the linked list
 * that will store the environment variables.
 * @param var a string representing the key of the variable to be found,
 * typically in the format "KEY=VALUE".
 * @return a pointer to the t_env node that matches the key,
 ...
 * @return an integer representing the built-in command type,
 * or -1 if not a built-in command.
 */
int		is_builtin(const char *cmd);

/**
 * @brief Converts the environment linked list to an array of strings.
 * @param env a t_env pointer to the head of the linked list that
 * will store the environment variables.
...
/**
 * @brief Validates if a str is a valid shell identifier (until '=' if present).
